...
class ModelConfig:
    ...
    def generate_req_topic_list(self):
        ...
        req_ulog_topics_dict = self.dynamics_model_config["data"][
        ...
        self.dynamics_model_config["data"][
            "req_dataframe_topic_list"
        ] = req_dataframe_topic_list
        return
    ...
    def check_estimation_bools(self):
        ...
        assert (
            self.dynamics_model_config["estimate_forces"]
            or self.dynamics_model_config["estimate_moments"]
