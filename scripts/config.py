...
def parse_args():
    ...
    # architecture
    parser.add_argument('-N', '--model_type',      type=str,       default='transformer')
    ...
    parser.add_argument('--gradient_clip_val',     type=float,    default=0.7)
    ...
    parser.add_argument('--causal_masking',        type=bool,     default=False)
    parser.add_argument('--pos_encoder_type',      type=str,      default='learnable')
